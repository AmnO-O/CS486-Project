...
| phone_number | NVARCHAR(50) | YES | — | — | Optional |
...
| building | NVARCHAR(100) | NO | — | — | See Q3 (table vs varchar) |
| floor | NVARCHAR(50) | NO | — | — | See Q3 |
...
| expected_participants | INT | NO | — | provisional | vs capacity |
...
| initial_condition | NVARCHAR(MAX) | YES | — | — | At check-in; See Q5 |
| actual_end_time | DATETIME2 | YES | — | — | At completion |
| final_condition | NVARCHAR(MAX) | YES | — | — | At completion; See Q5 |
...
> ⚠️ **SNAPSHOT — generated from outputs/01-business-req-analysis-G05.md.**
> The live entity-registry.md already contains data. This snapshot is provided for
> review. A human should compare and decide whether to merge.
