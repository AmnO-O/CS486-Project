...
<!-- ## Libraries / tools forbidden

- No ORM-specific syntax in DDL (pure T-SQL only)
- No PostgreSQL-specific syntax (`SERIAL`, `UUID` gen functions, `::` cast operator)
- No MySQL-specific syntax (`AUTO_INCREMENT`, backtick identifiers) -->