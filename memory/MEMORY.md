...
Quick reference for all memory files. **Read in this order at the start of each session.**
...
After each task:
1. Update `Progress.md` — mark task as ✅ Approved or ⚠️ Needs revision
2. Update `ActiveContext.md` — point to the next task
3. Add decisions to `Progress.md` decisions log
4. Commit to git with message like: `docs: update memory for Task X completion`

---

**Current active task:** See `ActiveContext.md`
**Group name:** G05
