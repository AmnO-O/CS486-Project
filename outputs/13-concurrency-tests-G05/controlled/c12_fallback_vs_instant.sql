...
EXEC dbo.usp_booking_instant_submit
    ...
    @requested_start_time = @w7, @requested_end_time = DATEADD(hour, 2, @w7),
...
EXEC dbo.usp_booking_instant_submit
    ...
    @expected_participants = 10,
    @requested_start_time = DATEADD(minute, 30, @w7),
    @requested_end_time = DATEADD(hour, 1, DATEADD(minute, 30, @w7)),
