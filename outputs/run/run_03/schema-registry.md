...
| 6 | facility_assignments | entity | 🔒 | Facility_Assignments |
...
**Status:** 🔒 locked
**Maps from entity:** Facility_Assignments
**Primary key:** assignment_id (surrogate)
...
| status | VARCHAR(20) | NO | — | CHECK (status IN ('planned','active','completed','cancelled')), DEFAULT 'planned' | Business status (time state derived by app layer) |
...
| Column | References | On Delete | On Update |
|--------|-----------|-----------|-----------|
| facility_id | facilities.facility_id | NO ACTION | NO ACTION |
| space_id | spaces.space_id | NO ACTION | NO ACTION |
| created_by | users.user_id | NO ACTION | NO ACTION |
...
| PK_facility_assignments | facility_assignments | assignment_id | Clustered |
| UQ_fac_assign_active | facility_assignments | facility_id (filtered WHERE status='active') | Unique non-clustered |
| idx_fac_assign_facility_id | facility_assignments | facility_id | Non-clustered |
| idx_fac_assign_space_id | facility_assignments | space_id | Non-clustered |
| idx_fac_assign_time_range | facility_assignments | facility_id, start_time, end_time | Non-clustered |
| idx_fac_assign_created_by | facility_assignments | created_by | Non-clustered |
...
| Gate | Status | Date |
|------|--------|------|
| Entity registry locked | ✅ 🔒 | Task 03 (2026-07-01) — 11 entities finalized (updated 2026-07-05: removed Space_Facilities, added Facility_Categories + Incidents + **Facility_Assignments**) |
| Schema registry populated | ✅ 🔒 | Task 03 (2026-07-01) — regenerated with 11-table schema (updated 2026-07-05: removed space_facilities, added facility_categories + incidents; **2026-07-05: added facility_assignments**) |
...
*Last updated: 2026-07-05 — 11-table schema: +facility_assignments (time-range tracking, facilities.space_id cached)*
