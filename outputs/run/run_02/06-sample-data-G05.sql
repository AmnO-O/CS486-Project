...
-- Task 06: Sample Data Preparation (Run 02)
-- Dependency: run after outputs/run/run_02/05-db-definition-G05.sql
...
-- - Run 02 changes: space_facilities table removed; facilities carry space_id
--   directly (nullable for in-storage devices); facility_categories reference
--   data seeded; incidents table seeded with full lifecycle.
-- ============================================================
...
PRINT 'VERIFY: V17 - Task 06 run_02 sample data generation completed';
