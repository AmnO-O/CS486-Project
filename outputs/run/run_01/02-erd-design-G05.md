...
| R6 | Spaces ↔ Facilities | M:N | `Spaces \|\|--o{ Space_Facilities` / `Facilities \|\|--o{ Space_Facilities` | A Space may contain zero or many Facility instances; a Facility instance may be assigned to zero or many Spaces. The junction table Space_Facilities resolves the M:N with a composite PK of (space_id, facility_id), assigning individual device instances to rooms. |
...
- [x] All 11 entities from entity-registry are present (Departments, Users, Spaces, Facility_Categories, Facilities, Space_Facilities, Bookings, Booking_Approvals, Booking_Sessions, Maintenance, Incidents)
...
- [x] Cardinality is correct: 1:N for R1–R5, R7–R9, R12–R13, R15; M:N resolved via junction for R6; 1:0..1 for R10–R11; 1:N partial for R14, R16, R17
...
- [x] Key design decisions documented in `docs/design-decisions.md` (incident run_01 amendment, facility refactoring, building/floor, rejection reason, SRP split)
