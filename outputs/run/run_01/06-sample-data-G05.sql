...
INSERT INTO [dbo].[facilities] ([category_id], [status]) VALUES
-- Projectors (5)
(@cat_pro, 'active'), (@cat_pro, 'active'), (@cat_pro, 'active'), (@cat_pro, 'active'), (@cat_pro, 'inactive'),
-- Whiteboards (7)
(@cat_whb, 'active'), (@cat_whb, 'active'), (@cat_whb, 'active'), (@cat_whb, 'active'), (@cat_whb, 'active'), (@cat_whb, 'active'), (@cat_whb, 'retired'),
-- Microphones (6)
(@cat_mic, 'active'), (@cat_mic, 'active'), (@cat_mic, 'active'), (@cat_mic, 'active'), (@cat_mic, 'inactive'), (@cat_mic, 'lost'),
-- Computers (47)
(@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'),
(@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'),
(@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'),
(@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'),
(@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'),
(@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'active'),
(@cat_com, 'active'), (@cat_com, 'active'), (@cat_com, 'inactive'), (@cat_com, 'retired'),
-- Air conditioners (9)
(@cat_air, 'active'), (@cat_air, 'active'), (@cat_air, 'active'), (@cat_air, 'active'), (@cat_air, 'inactive'), (@cat_air, 'active'), (@cat_air, 'active'), (@cat_air, 'active'), (@cat_air, 'active'),
...
INSERT INTO [dbo].[space_facilities] ([space_id], [facility_id]) VALUES
-- @sp_aud (Main Auditorium): 2 projectors, 6 microphones, 1 livestreaming, 4 ACs
(@sp_aud, 1),  (@sp_aud, 2),
(@sp_aud, 13), (@sp_aud, 14), (@sp_aud, 15), (@sp_aud, 16), (@sp_aud, 17), (@sp_aud, 18),
(@sp_aud, 75),
(@sp_aud, 66), (@sp_aud, 67), (@sp_aud, 68), (@sp_aud, 69),
-- @sp_class (Classroom 101): 1 projector, 2 whiteboards, 1 AC
(@sp_class, 3),
(@sp_class, 6), (@sp_class, 7),
(@sp_class, 70),
-- @sp_lab (Computer Lab 201): 1 projector, 30 computers, 2 ACs
(@sp_lab, 4),
(@sp_lab, 19), (@sp_lab, 20), (@sp_lab, 21), (@sp_lab, 22), (@sp_lab, 23), (@sp_lab, 24), (@sp_lab, 25),
(@sp_lab, 26), (@sp_lab, 27), (@sp_lab, 28), (@sp_lab, 29), (@sp_lab, 30), (@sp_lab, 31), (@sp_lab, 32),
(@sp_lab, 33), (@sp_lab, 34), (@sp_lab, 35), (@sp_lab, 36), (@sp_lab, 37), (@sp_lab, 38), (@sp_lab, 39),
(@sp_lab, 40), (@sp_lab, 41), (@sp_lab, 42), (@sp_lab, 43), (@sp_lab, 44), (@sp_lab, 45), (@sp_lab, 46),
(@sp_lab, 47), (@sp_lab, 48),
(@sp_lab, 71), (@sp_lab, 72),
-- @sp_project (Project Lab 301): 1 projector, 1 whiteboard, 12 computers
(@sp_project, 5),
(@sp_project, 8),
(@sp_project, 49), (@sp_project, 50), (@sp_project, 51), (@sp_project, 52), (@sp_project, 53), (@sp_project, 54),
(@sp_project, 55), (@sp_project, 56), (@sp_project, 57), (@sp_project, 58), (@sp_project, 59), (@sp_project, 60),
-- @sp_meeting (Meeting Room 401): 1 projector, 1 whiteboard
(@sp_meeting, 9), (@sp_meeting, 10),
-- @sp_workspace (Student Workspace 501): 3 whiteboards, 2 ACs
(@sp_workspace, 11), (@sp_workspace, 12),
(@sp_workspace, 73), (@sp_workspace, 74),
-- @sp_restoration (Classroom 102): 5 computers
(@sp_restoration, 61), (@sp_restoration, 62), (@sp_restoration, 63), (@sp_restoration, 64), (@sp_restoration, 65);
...
BEGIN TRY
    ...
    INSERT INTO [dbo].[facilities] ([category_id], [status])
    VALUES (@cat_pro, 'unknown_status');
    ROLLBACK TRANSACTION;
...
PRINT 'VERIFY: V04 - facility assignments by space and category';
...
PRINT 'VERIFY: V17 - Task 06 sample data generation completed';
