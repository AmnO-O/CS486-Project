...
|---|---|---|---|
| 01 business-req-analysis | common reads; `req/business-requirement.md` | `outputs/01-business-req-analysis-G05.md`; `docs/entity-registry.md` (or `logs/registry-snapshots/*` depending on agent strategy) to populate entities, attributes, relationships. | any `outputs/02..07`; `docs/schema-registry.md` |
| 02 erd-design | common reads; `outputs/01-business-req-analysis-G05.md`; `docs/entity-registry.md` | `outputs/02-erd-design-G05.md`; `docs/entity-registry.md (optional refine relationships/cardinalities, only if refinements are needed) | `docs/schema-registry.md`; any unrelated `outputs/` |
...
| 05 ddl | common reads; `outputs/01-business-req-analysis-G05.md`; `outputs/04-design-validation-G05.md`; `docs/schema-registry.md` (RO, locked source of truth) | `outputs/05-db-definition-G05.sql` or project variant `outputs/05-ddl-G05.sql; `logs/eval/task05/<timestamp>-05-ddl-compile.log`` | `docs/schema-registry.md`; `docs/entity-registry.md`; any prior `outputs/` |
