---
description: Generate a Mermaid.js ERD for the Campus Space Management System.
---

Command: generate-erd

Description:
Run the `db-design-pipeline:02-erd` skill to generate a Mermaid.js ERD from `docs/entity-registry.md` and `outputs/01-business-req-analysis-G05.md`.
